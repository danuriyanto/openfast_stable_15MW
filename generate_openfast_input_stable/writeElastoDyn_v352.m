...
A(end+1,1) = {[num2str(ElastoDyn.BlPitch,1) ' BlPitch(1) - Blade 1 initial pitch (degrees)	']};
A(end+1,1) = {[num2str(ElastoDyn.BlPitch,1) ' BlPitch(2) - Blade 2 initial pitch (degrees)	']};
A(end+1,1) = {[num2str(ElastoDyn.BlPitch,1) ' BlPitch(3) - Blade 3 initial pitch (degrees) [unused for 2 blades]	']};
A(end+1,1) = {['0.0 TeetDefl - Initial or fixed teeter angle (degrees) [unused for 3 blades]	']};
A(end+1,1) = {[num2str(ElastoDyn.Azimuth,1) '	Azimuth - Initial azimuth angle for blade 1 (degrees)	']};
A(end+1,1) = {[num2str(ElastoDyn.RotSpeed,2) '	 RotSpeed - Initial or fixed rotor speed (rpm)	']};
A(end+1,1) = {[num2str(ElastoDyn.NacYaw,1) '	 NacYaw - Initial or fixed nacelle-yaw angle (degrees)	']};
