function[IM] = createIM(hazard,depth)
...
windTry = 1:5:80; %1:4:1.5*max(ceil(Vw));
break_height = 0.78*depth;
waveTry = 1:1.5:ceil(break_height/1.86);
...
spaceFactor = 1.75; %Used to expand the convex hull, only used if this is the 1,000 year catalog
